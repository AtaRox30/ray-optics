var graphs = {
    ...
    **/
    ...
    circle: function(c, r) {
        ({type: 5, c: c, r: this.line_segment(c, r), exist: true})
        ({type: 5, c: c, r: r, exist: true})
    },
    /**
    * inner product
    * @method dot
    ...
    **/
    intersection: function(obj1, obj2) {
      // line & line
        (this.intersection_2line(obj1, obj2));
      // line & circle
        (this.intersection_line_circle(obj1, obj2));
      // circle & line
        (this.intersection_line_circle(obj2, obj1));
    },
    /**
    ...
    **/
    intersection_2line: function(l1, l2) {
      graphs.point((A * xb - B * xa) / (xa * yb - xb * ya), (A * yb - B * ya) / (xa * yb - xb * ya));
    },
    /**
  ...
  var canvasPainter = {
    ...
    rayIntersection: function(obj, ray) {
        return //L'intersection de la tête et du miroir qui renvoie la lumière
    }
    ...
    //======================================Créer un objet=========================================
    create: function(mouse) {
      console.log("Test create on idealmirror object");
